...
(
    ...
    UNIQUE KEY UK_4yaf6tjm0jduantayvd4bqts8 (driver_id),
    UNIQUE KEY UK_h4ivmkbkxkh2ngoqn3i0tu3ky (partner_id)
) ENGINE = MyISAM
  DEFAULT CHARSET = utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
(
    ...
    PRIMARY KEY (`id`),
    UNIQUE KEY UK_tjmofyrt4whp0m1vaql9njjdo (registration(20)) USING HASH
) ENGINE = MyISAM
  DEFAULT CHARSET = utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
